...
```bash
git clone https://github.com/segunojo1/pitch-hub
cd pitch-hub
```
...
Thanks  to <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> for the tutorial